...
### NEXT UP
REMAINING BEFORE DELIVERY (updated 2026-07-13): (1) Windows-box pass — icon in Explorer, cross-platform .bsp load both directions, open-on-launch + registry association per WINDOWS_PACKAGING.md; (2) optional :340 clamp (TODO 7 — root-caused, one-line fix parked, needs T27/T28 re-verify); (3) Carter to ratify the DECISIONS REQUIRING CLIENT RATIFICATION section below.
