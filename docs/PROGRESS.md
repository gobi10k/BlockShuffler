...
### NEXT UP
REMAINING BEFORE DELIVERY (updated 2026-07-15 — **Mac slice COMPLETE, all acceptance rows PASS on Mac**): (1) Windows slice — 12.2 spot-run, Section C parity, Windows-Release column, MSVC harness, per WINDOWS_PACKAGING.md; (2) Carter to ratify the DECISIONS REQUIRING CLIENT RATIFICATION section below (also tagged in VALIDATION_PLAN BEYOND-SPEC); (3) optional :340 clamp (TODO 7 — root-caused, one-line fix parked, needs T27/T28 re-verify).
